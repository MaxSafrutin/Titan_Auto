...
function ensureSystemFolders(){var root=getRootFolder();return {vehicles:getOrCreateFolder(root,'VEHICLES').getId(),backups:getOrCreateFolder(root,'BACKUPS').getId(),exports:getOrCreateFolder(root,'EXPORTS').getId()};}
